...
# Set the command to run the FastAPI application using gunicorn
...
# CMD ["sh", "-c", "echo '">>> Container started successfully! Waiting...' && sleep infinity"] 
